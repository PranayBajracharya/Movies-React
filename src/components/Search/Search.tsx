        ...
        >
          {results.map((result) => (
            ...
            >
              ...
              ></Image>
              <VStack marginLeft="10px" alignItems="flex-start" fontSize="14px">
                <Heading size="sm">{result.name ?? result.title}</Heading>
                <HStack>
                  {result.media_type === "movie" && <Text>Movie</Text>}
                  {result.media_type === "tv" && <Text>TV Series</Text>}
